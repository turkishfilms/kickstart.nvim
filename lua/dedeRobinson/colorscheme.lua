vim.cmd 'highlight StatusLine guifg=black guibg=none'
vim.cmd 'highlight StatusLineNC guifg=black guibg=none'
...
vim.cmd 'highlight NoiceCmdline guifg=#000000 guibg=#cccccc' --everywhere idk
...
vim.cmd 'highlight DiagnosticSignWarn guifg=#cccccc' --/ symbol when searching
vim.cmd 'highlight NotifyBackground guibg=#000000 guifg=#222222' --notificatio background
...
vim.cmd 'highlight TabLineFill guifg=clear '
---------------------------------------------------
--NETRW--
...
vim.cmd 'highlight TabLineFill guibg=white guifg=none' --tabline bg
----------------------------------------------------
--NVIM--
